	...
	<div class="container-fluid">
		...
		<ul class="nav justify-content-center nav-pills" id="menu">
			...
			<li class="nav-item dropdown">
				...
				<a class="dropdown-item" href="?controller=titre&action=all_titre">Par titre</a>					<a class="dropdown-item" href="?controller=livre&action=all_livres">Tous les livres</a>
